...
description: >
  ...
  documentation. Use when the implementation approach is not yet clear, or when a question
  about the codebase needs answering before deciding.
tools: Read, Grep, Glob
model: sonnet
effort: medium
---

<!-- GENERATED by tools/gen_agents.py from .agents/agents/explorer.md — do not edit -->
